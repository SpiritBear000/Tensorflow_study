'''
tensorflow基本运行模式: https://blog.csdn.net/jdzwanghao/article/details/81046840
...
mnist = input_data.read_data_sets("/media/lab210/文档/WH_HOME/_datasets_study_/MNIST_data", one_hot=True)
